...
namespace IO.Swagger.Model
{
        ...
        public partial class MethodInfo :  IEquatable<MethodInfo>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets ReturnParameter
        /// </summary>
        [DataMember(Name="returnParameter", EmitDefaultValue=false)]
        public  ReturnParameter { get; private set; }

        /// <summary>
        /// Gets or Sets ReturnType
        /// </summary>
        [DataMember(Name="returnType", EmitDefaultValue=false)]
        public  ReturnType { get; private set; }

        /// <summary>
        /// Gets or Sets ReturnTypeCustomAttributes
        /// </summary>
        [DataMember(Name="returnTypeCustomAttributes", EmitDefaultValue=false)]
        public  ReturnTypeCustomAttributes { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReturnParameter: ").Append(ReturnParameter).Append("\n");
            sb.Append("  ReturnType: ").Append(ReturnType).Append("\n");
            sb.Append("  ReturnTypeCustomAttributes: ").Append(ReturnTypeCustomAttributes).Append("\n");
        ...
        public bool Equals(MethodInfo input)
        {
            ...
            return 
                ...
                (
                    this.ReturnParameter == input.ReturnParameter ||
                    this.ReturnParameter != null &&
                    input.ReturnParameter != null &&
                    this.ReturnParameter.SequenceEqual(input.ReturnParameter)
                ) && 
                (
                    this.ReturnType == input.ReturnType ||
                    this.ReturnType != null &&
                    input.ReturnType != null &&
                    this.ReturnType.SequenceEqual(input.ReturnType)
                ) && 
                (
                    this.ReturnTypeCustomAttributes == input.ReturnTypeCustomAttributes ||
                    this.ReturnTypeCustomAttributes != null &&
                    input.ReturnTypeCustomAttributes != null &&
                    this.ReturnTypeCustomAttributes.SequenceEqual(input.ReturnTypeCustomAttributes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReturnParameter != null)
                    hashCode = hashCode * 59 + this.ReturnParameter.GetHashCode();
                if (this.ReturnType != null)
                    hashCode = hashCode * 59 + this.ReturnType.GetHashCode();
                if (this.ReturnTypeCustomAttributes != null)
                    hashCode = hashCode * 59 + this.ReturnTypeCustomAttributes.GetHashCode();
