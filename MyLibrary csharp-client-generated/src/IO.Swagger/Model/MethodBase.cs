...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MethodBase :  IEquatable<MethodBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MethodBase);
        }

        /// <summary>
        /// Returns true if MethodBase instances are equal
        /// </summary>
        /// <param name="input">Instance of MethodBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MethodBase input)
        {
            if (input == null)
                return false;
