...
namespace IO.Swagger.Model
{
        ...
        public partial class Book :  IEquatable<Book>, IValidatableObject
    {
        ...
        /// <param name="authorFirstName">authorFirstName.</param>
        /// <param name="authorLastName">authorLastName.</param>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        public Book(Guid? id = default(Guid?), string authorFirstName = default(string), string authorLastName = default(string), string title = default(string), string description = default(string))
        {
            this.Id = id;
