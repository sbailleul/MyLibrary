...
namespace IO.Swagger.Model
{
        ...
        public partial class AuthorForUpdate :  IEquatable<AuthorForUpdate>, IValidatableObject
    {
        ...
        public AuthorForUpdate(string firstName = default(string), string lastName = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for AuthorForUpdate and cannot be null");
            }
            else
            {
            ...
            if (lastName == null)
            {
                throw new InvalidDataException("lastName is a required property for AuthorForUpdate and cannot be null");
            }
            else
            {
